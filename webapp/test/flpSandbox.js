		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#InnovationCampmyfirstproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"InnovationCampmyfirstproject-display": {
								"semanticObject": "InnovationCampmyfirstproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=FeedbackApp",
									"url": sap.ui.require.toUrl("FeedbackApp")
								}
							}
						}
					}
